...
SANTA_IMAGE = pygame.image.load(os.path.join(
    r'C:\Users\bayar\OneDrive\Desktop\Techne club\Neelttei haalga\Games\Santa game\Assets\santa.png'))
SANTA1 = pygame.transform.scale(SANTA_IMAGE, (SANTA_WIDTH, SANTA_HEIGHT))

SANTA2_IMAGE = pygame.image.load(os.path.join(
    r'C:\Users\bayar\OneDrive\Desktop\Techne club\Neelttei haalga\Games\Santa game\Assets\gaigui_santa.png'))
SANTA2 = pygame.transform.scale(
    SANTA2_IMAGE, (SANTA_WIDTH, SANTA_HEIGHT))


SNOWBALL_IMAGE = pygame.image.load(os.path.join(
    r'C:\Users\bayar\OneDrive\Desktop\Techne club\Neelttei haalga\Games\Santa game\Assets\Snowball.png'))
SNOWBALL = pygame.transform.scale(
    SNOWBALL_IMAGE, (SNOWBALL_WIDTH, SNOWBALL_HEIGHT))

PROJECTILE1_IMAGE = pygame.image.load(
    os.path.join(r'C:\Users\bayar\OneDrive\Desktop\Techne club\Neelttei haalga\Games\Santa game\Assets\ice projectile.png'))
...
PRESENT_GREEN_IMAGE = pygame.image.load(
    os.path.join(r'C:\Users\bayar\OneDrive\Desktop\Techne club\Neelttei haalga\Games\Santa game\Assets\present_green.png'))
PRESENT_GREEN = pygame.transform.scale(
    PRESENT_GREEN_IMAGE, (PRESENT_WIDTH, PRESENT_HEIGHT))

PRESENT_RED_IMAGE = pygame.image.load(
    os.path.join(r'C:\Users\bayar\OneDrive\Desktop\Techne club\Neelttei haalga\Games\Santa game\Assets\present_red.png'))
PRESENT_RED = pygame.transform.scale(
    PRESENT_RED_IMAGE, (PRESENT_WIDTH, PRESENT_HEIGHT))

BACKGROUND_IMAGE = pygame.image.load(
    os.path.join(r'C:\Users\bayar\OneDrive\Desktop\Techne club\Neelttei haalga\Games\Santa game\Assets\background_img.jpg'))
